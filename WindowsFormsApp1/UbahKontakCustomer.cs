...
{
    public partial class UbahKontakCustomer : Form
    {
        public UbahKontakCustomer()
        {
            InitializeComponent();
        }
        ...
        private void btdelete_Click(object sender, EventArgs e)
        {
            ...
            string sql = "DELETE FROM customer WHERE customer_id = '" + tbid.Text + "' ";
            conn.Open();
        ...
        private void btsimpan_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                string connectionString = "server=localhost;uid=root;pwd=;database=ud_sinar_mas";
                MySqlConnection conn = new MySqlConnection(connectionString);
                string sql = "UPDATE customer SET nama_customer = '" + tbnama.Text + "', alamat = '" + tbalamat.Text + "', no_telepon = '" + tbnotelp.Text + "' WHERE customer_id = '" + tbid.Text + "' ";
                conn.Open();
                MySqlCommand cmd = new MySqlCommand(sql, conn);
                cmd.ExecuteNonQuery();
