    ...
    public partial class Reminder : Form
    {
        ...
        private void Reminder_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                string sqlutang = "SELECT nama_customer 'Customer', grand_total 'Total Penjualan', total_bayar 'Total Pembayaran', (grand_total - total_bayar) 'Sisah Pembayaran', tanggal_jatuh_tempo 'Jatuh Tempo' FROM customer, transaksi_penjualan WHERE `status` = 0 AND customer.customer_id = transaksi_penjualan.customer_id AND tanggal_jatuh_tempo >= CURRENT_DATE";
